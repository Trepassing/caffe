...
_UPSAMPLEPARAMETER_UPSAMPLEOP = _descriptor.EnumDescriptor(
  name='UpsampleOp',
  full_name='caffe.UpsampleParameter.UpsampleOp',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_UPSAMPLEPARAMETER_UPSAMPLEOP)
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='permute_param', full_name='caffe.LayerParameter.permute_param', index=60,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='upsample_param', full_name='caffe.LayerParameter.upsample_param', index=61,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reorg_param', full_name='caffe.LayerParameter.reorg_param', index=62,
...
_UPSAMPLEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='height', full_name='caffe.UpsampleParameter.height', index=0,
      number=1, type=5, cpp_type=1, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='width', full_name='caffe.UpsampleParameter.width', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=32,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='height_scale', full_name='caffe.UpsampleParameter.height_scale', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=2,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='width_scale', full_name='caffe.UpsampleParameter.width_scale', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=2,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mode', full_name='caffe.UpsampleParameter.mode', index=4,
      number=5, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPSAMPLEPARAMETER.fields_by_name['mode'].enum_type = _UPSAMPLEPARAMETER_UPSAMPLEOP
_UPSAMPLEPARAMETER_UPSAMPLEOP.containing_type = _UPSAMPLEPARAMETER
