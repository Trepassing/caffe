...
std::string prototxt_path = "/workspace/tools/yolov5_onnx2caffe/weights/railway.prototxt"; // "/workspace/tools/yolov5_onnx2caffe/weights/yolov5s-simple.prototxt";
std::string caffemodel_path = "/workspace/tools/yolov5_onnx2caffe/weights/railway.caffemodel"; // "/workspace/tools/yolov5_onnx2caffe/weights/yolov5s-simple.caffemodel";
std::string pic_path = "/workspace/tools/rs05504.jpg";
...
int main()
{
    ...
    cv::imwrite("result.jpg", showImage);
